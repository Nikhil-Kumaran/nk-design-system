...
const Button = (_a) => {
    ...
    return (React.createElement("button", Object.assign({ onClick: onClick, type: "button", className: buttonClasses }, props), label));
};

const Dropdown = ({ menuItems }) => {
    const [isOpen, setIsOpen] = useState(false);
    return (React.createElement("div", null,
        React.createElement(Button, { label: "Dropdown", onClick: () => setIsOpen(!isOpen) }),
        isOpen && (React.createElement("div", { className: "mt-2 shadow-lg w-48 rounded-md border border-gray-300" }, menuItems.map(({ label, value }) => (React.createElement("div", { className: "p-2 m-2 rounded-md hover:bg-gray-200 cursor-pointer", key: value }, label)))))));
};
